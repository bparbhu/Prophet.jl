...
md"""
# Neural Turing Backend

This notebook fits the Flux/Turing backend that keeps Prophet's structured terms and adds a Bayesian neural residual.
"""

# ╔═╡ 44444444-bbbb-4444-4444-444444444444
begin
    n = 90
    ...
    df = DataFrame(ds=ds, y=Float64.(y), event=event)
end

# ╔═╡ 55555555-bbbb-5555-5555-555555555555
begin
...
# ╔═╡ 66666666-bbbb-6666-6666-666666666666
begin
    future = Prophet.make_future_dataframe(model; periods=14)
    future.event = vcat(df.event, zeros(14))
    forecast = Prophet.predict(model, future)
end

# ╔═╡ 77777777-bbbb-7777-7777-777777777777
DataFrame(
...
# ╔═╡ 88888888-bbbb-8888-8888-888888888888
last(forecast, 10)
